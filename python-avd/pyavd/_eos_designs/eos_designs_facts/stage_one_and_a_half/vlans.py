...
class VlansMixin(Protocol):
    ...
    def vlans(self: FactsStageOneProtocol) -> None:
        """
        Return the compressed list of vlans to be defined on this switch after filtering network services and considering only_vlans_in_use.
        ...
        This also excludes any vlans in use on downstream switches.
        """
