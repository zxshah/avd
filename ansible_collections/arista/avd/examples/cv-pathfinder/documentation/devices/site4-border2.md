...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.17.42/24 | 192.168.17.1 |
...
| ------------ | --------------------------------- | ------------------------- | ---- | ------------------- | ---------- | ---------- |
| FLOW-TRACKER | 70000 | 5000 | - | 1 | Ethernet3 | - |
...
| --------- | --------------- | ------------ | --------- |
| SITE4 | Vlan4094 | 10.255.252.24 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_site4-border1_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_site4-border1_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
!
interface Ethernet3
   description P2P_site4-wan1_Ethernet2
   no shutdown
   mtu 9214
   no switchport
   flow tracker sampled FLOW-TRACKER
   ip address 10.0.4.58/31
!
interface Ethernet5
   description MLAG_site4-border1_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_site4-border1_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
interface Port-Channel5
   description MLAG_site4-border1_Port-Channel5
   no shutdown
...
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.42.13/32 |
...
!
interface Vxlan1
   description site4-border2_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.0.4.59 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.251.24 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | BLUE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.251.24 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | RED | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 42 | 192.168.255.14:10042 | 10042:10042 | - | - | learned |
| 666 | 192.168.255.14:10666 | 10666:10666 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| BLUE | 192.168.255.14:100 | connected | - |
| RED | 192.168.255.14:101 | connected | - |
...
router bgp 65104
   ...
   neighbor 10.255.251.24 description site4-border1_Vlan4093
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 42
      rd 192.168.255.14:10042
      route-target both 10042:10042
      redistribute learned
   !
   vlan 666
      rd 192.168.255.14:10666
   ...
   !
   vrf BLUE
      rd 192.168.255.14:100
      route-target import evpn 100:100
      route-target export evpn 100:100
      router-id 192.168.255.14
      neighbor 10.255.251.24 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.24 description site4-border1_Vlan3099
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf RED
      rd 192.168.255.14:101
      route-target import evpn 101:101
      route-target export evpn 101:101
      router-id 192.168.255.14
      neighbor 10.255.251.24 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.24 description site4-border1_Vlan3100
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
