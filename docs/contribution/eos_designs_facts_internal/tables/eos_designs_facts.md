...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;underlay_multicast_pim_sm_enabled</samp>](## "uplinks.[].underlay_multicast_pim_sm_enabled") | Boolean |  |  |  |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;underlay_multicast_pim_sm_uplinks</samp>](## "uplinks.[].underlay_multicast_pim_sm_uplinks") | List, items: String |  |  |  |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "uplinks.[].underlay_multicast_pim_sm_uplinks.[]") | String |  |  |  |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;underlay_multicast_static_enabled</samp>](## "uplinks.[].underlay_multicast_static_enabled") | Boolean |  |  |  |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;underlay_multicast_static_uplinks</samp>](## "uplinks.[].underlay_multicast_static_uplinks") | List, items: String |  |  |  |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "uplinks.[].underlay_multicast_static_uplinks.[]") | String |  |  |  |  |
...
=== "YAML"
    ...
    uplinks: # required
      - interface: <str; required>
        ...
        underlay_multicast_pim_sm_enabled: <bool>
        underlay_multicast_pim_sm_uplinks:
          - <str>
        underlay_multicast_static_enabled: <bool>
        underlay_multicast_static_uplinks:
          - <str>
        ipv6_enable: <bool>
        prefix_length: <int>
        ip_address: <str>
