...
| Ethernet51 | L2_S1_SPINE1_Ethernet1 | *trunk | *10,110,120,130 | *- | *- | 51 |
| Ethernet53 | MLAG_S1_LEAF1B_Ethernet53 | *trunk | *- | *- | *MLAG | 53 |
| Ethernet54 | MLAG_S1_LEAF1B_Ethernet54 | *trunk | *- | *- | *MLAG | 53 |
...
interface Ethernet51
   description L2_S1_SPINE1_Ethernet1
   no shutdown
   channel-group 51 mode active
!
interface Ethernet53
   description MLAG_S1_LEAF1B_Ethernet53
   no shutdown
   channel-group 53 mode active
!
interface Ethernet54
   description MLAG_S1_LEAF1B_Ethernet54
   no shutdown
   channel-group 53 mode active
```
...
| Port-Channel53 | MLAG_S1_LEAF1B_Port-Channel53 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel53
   description MLAG_S1_LEAF1B_Port-Channel53
   no shutdown
   switchport mode trunk
