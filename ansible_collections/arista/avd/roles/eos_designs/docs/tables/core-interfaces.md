...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;underlay_multicast</samp>](## "core_interfaces.p2p_links_profiles.[].underlay_multicast") <span style="color:red">deprecated</span> | Boolean |  | `False` |  | Enable PIM sparse mode. Requires `include_in_underlay_protocol` and the global `underlay_multicast` to be `true`.<span style="color:red">This key is deprecated. Support will be removed in AVD version 6.0.0. Use <samp>p2p_links.underlay_multicast_pim_sm</samp> instead.</span> |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;underlay_multicast_pim_sm</samp>](## "core_interfaces.p2p_links_profiles.[].underlay_multicast_pim_sm") | Boolean |  |  |  | Enable/Disable Protocol Independent Multicast sparse mode. Requires the global `underlay_multicast_pim_sm` to be `true`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;underlay_multicast_static</samp>](## "core_interfaces.p2p_links_profiles.[].underlay_multicast_static") | Boolean |  |  |  | Enable/Disable static Protocol Independent Multicast. Requires the global `underlay_multicast_static` to be `true`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;underlay_multicast</samp>](## "core_interfaces.p2p_links.[].underlay_multicast") <span style="color:red">deprecated</span> | Boolean |  | `False` |  | Enable PIM sparse mode. Requires `include_in_underlay_protocol` and the global `underlay_multicast` to be `true`.<span style="color:red">This key is deprecated. Support will be removed in AVD version 6.0.0. Use <samp>p2p_links.underlay_multicast_pim_sm</samp> instead.</span> |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;underlay_multicast_pim_sm</samp>](## "core_interfaces.p2p_links.[].underlay_multicast_pim_sm") | Boolean |  |  |  | Enable/Disable Protocol Independent Multicast sparse mode. Requires the global `underlay_multicast_pim_sm` to be `true`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;underlay_multicast_static</samp>](## "core_interfaces.p2p_links.[].underlay_multicast_static") | Boolean |  |  |  | Enable/Disable static Protocol Independent Multicast. Requires the global `underlay_multicast_static` to be `true`. |
    ...
    core_interfaces:
      ...
      p2p_links_profiles:
        ...
        - name: <str; required; unique>
          ...
          # Use <samp>p2p_links.underlay_multicast_pim_sm</samp> instead.
