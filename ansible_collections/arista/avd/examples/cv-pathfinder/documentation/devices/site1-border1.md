...
| --------- | ----------- | ---- | ------------- |
| Ethernet5 | MLAG_site1-border2_Ethernet5 | active | 5 |
| Ethernet6 | MLAG_site1-border2_Ethernet6 | active | 5 |
...
| --------- | ----------- | --- | --- | -------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_site1-border2_Port-Channel5 | default | - | False | - | - | - | - |
