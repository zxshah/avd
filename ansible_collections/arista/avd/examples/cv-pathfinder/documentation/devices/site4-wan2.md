...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.17.44/24 | 192.168.17.1 |
...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 192.168.42.16/32 | - | 9194 | Hardware: FLOW-TRACKER |  |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_site4-border1_Ethernet4 | - | 10.0.4.61/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_site4-border2_Ethernet4 | - | 10.0.4.63/31 | default | 9214 | False | - | - |
| Ethernet3 | ACME-MPLS-INC_mpls-site4-wan2_mpls-cloud_Ethernet9 | - | 172.18.41.2/24 | default | - | False | - | - |
| Ethernet4 | REGION1-INTERNET-CORP_inet-site4-wan2_inet-cloud_Ethernet11 | - | 100.64.41.2 | default | - | False | ACL-INTERNET-IN_Ethernet4 | - |
...
!
interface Ethernet1
   description P2P_site4-border1_Ethernet4
   no shutdown
   mtu 9214
   no switchport
   flow tracker hardware FLOW-TRACKER
   ip address 10.0.4.61/31
!
interface Ethernet2
   description P2P_site4-border2_Ethernet4
   no shutdown
   mtu 9214
   no switchport
   flow tracker hardware FLOW-TRACKER
   ip address 10.0.4.63/31
!
interface Ethernet3
   description ACME-MPLS-INC_mpls-site4-wan2_mpls-cloud_Ethernet9
   no shutdown
   no switchport
   flow tracker hardware FLOW-TRACKER
   ip address 172.18.41.2/24
!
interface Ethernet4
   description REGION1-INTERNET-CORP_inet-site4-wan2_inet-cloud_Ethernet11
   no shutdown
   no switchport
   flow tracker hardware FLOW-TRACKER
   ip address 100.64.41.2
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.255.16/32 |
...
| default | 172.18.0.0/16 | 172.18.41.1 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route 172.18.0.0/16 172.18.41.1
...
| 192.168.255.13 | Inherited from peer group EVPN-OVERLAY-PEERS | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
...
| --- | ------------------- | ------------ |
| BLUE | 192.168.255.16:100 | connected |
| default | 192.168.255.16:1 | - |
| RED | 192.168.255.16:101 | connected |
...
| 20 | permit 192.168.42.16/32 eq 32 |
...
ip prefix-list PL-LOOPBACKS-EVPN-OVERLAY
   ...
   seq 20 permit 192.168.42.16/32 eq 32
```
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 192.168.255.16:102 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 192.168.255.16:102 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 192.168.255.16:102 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 192.168.255.16:102 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 192.168.255.16:102
```
...
ip access-list ACL-INTERNET-IN_Ethernet4
   ...
   10 permit udp any host 100.64.41.2 eq isakmp non500-isakmp
   30 permit icmp any host 100.64.41.2
   deny ip any any
```
