        ...
        for peer in self._avd_peers:
            ...
            for uplink in peer_facts.uplinks:
                ...
                downlink = EosDesignsFacts.UplinksItem(
                    ...
                    underlay_multicast_pim_sm_enabled=uplink.underlay_multicast_pim_sm_enabled,
                    underlay_multicast_static_enabled=uplink.underlay_multicast_static_enabled,
                    underlay_multicast_pim_sm_uplinks=uplink.underlay_multicast_pim_sm_uplinks,
                    underlay_multicast_static_uplinks=uplink.underlay_multicast_static_uplinks,
