...
| Ethernet97/1 | L2_S1_LEAF3A_Ethernet97/4 | *trunk | *10,310,320,330 | *- | *- | 971 |
| Ethernet97/2 | L2_S1_LEAF3B_Ethernet97/4 | *trunk | *10,310,320,330 | *- | *- | 971 |
...
interface Ethernet97/1
   description L2_S1_LEAF3A_Ethernet97/4
   no shutdown
   channel-group 971 mode active
!
interface Ethernet97/2
   description L2_S1_LEAF3B_Ethernet97/4
   no shutdown
   channel-group 971 mode active
```
