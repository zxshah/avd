...
| --------- | ----------- | ---- | ------------- |
| Ethernet3 | MLAG_dc2-leaf2a_Ethernet3 | active | 3 |
| Ethernet4 | MLAG_dc2-leaf2a_Ethernet4 | active | 3 |
| Ethernet5 | SERVER_dc2-leaf2-server1_PCI2 | active | 5 |
| Ethernet8 | L2_dc2-leaf2c_Ethernet2 | active | 8 |
...
| --------- | ----------- | --- | --- | -------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_dc2-leaf2a_Port-Channel3 | default | - | False | - | - | - | - |
